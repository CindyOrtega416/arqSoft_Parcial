...
public class ComentarioController {
	...
	@RequestMapping(value = "/{id}", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE) // traer
																												// comentarios
																												// por
																												// id
	...
	public @ResponseBody List<ComentarioResponseDto> getAllComentariosByTareaId(@PathVariable("id") Long id)
